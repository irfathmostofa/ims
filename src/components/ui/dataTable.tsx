...
type PrintColumn<T> = {
  label: string; // column header for PDF
  value: keyof T; // field in your data
};
...
export function DataTable<T extends Record<string, any>>({
  ...
  const exportPDF = () => {
    ...
    // Use custom printHead if provided
    ...
    const body = filteredData.map((row) =>
      columnsToPrint.map((col) => {
        ...
        // Handle image fields (optional: show placeholder or embed)
